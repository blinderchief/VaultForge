...
NEXT_PUBLIC_VAULT_IMPL_ADDRESS=0x671419bb5a8CeF7547f661212030F998B7992ACE
...
| `/vault/create` | 4-step wizard: Connect Wallet â†’ Configure Vault â†’ Deposit Collateral (with LTV optimization preview) â†’ Confirm (3 real transactions: deploy clone â†’ approve ERC-20 â†’ deposit). |
